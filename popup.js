function sendMessageToActiveTab(message) {
  chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
    ...
    if (activeTab.url.startsWith('chrome://') || activeTab.url.startsWith('edge://') || activeTab.url.startsWith('about:')) {
      document.body.innerHTML = '<div style="padding:10px; color:#d32f2f; font-family:system-ui; font-size:13px;">Cannot screenshot internal browser pages. Please try on a regular website.</div>';
      return;
    }
